    ...
    <div className="flex flex-col min-h-screen">
      ...
      <MaxWidthWrapper className="text-creme mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center flex-grow">
        ...
        <p className="mt-5 max-w-prose text-white sm:text-lg">
          Take this quiz to find out which computer science career best suits
          your personality. Understand your strengths and how they can guide
          your career decisions.
        </p>
        <div className="w-full mt-3 bg-[rgba(255,255,255,0.2)] p-4 rounded-lg shadow-lg italic text-white sm:text-lg">
          Choosing a career based on your personality not only leads to greater
          job satisfaction but also to a more fulfilling life. - Dr. Jane
          Goodall
        </div>
        <Link
